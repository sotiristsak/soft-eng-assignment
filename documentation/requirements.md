...
την κάρτα, στην λίστα των αγορασμένων του εισητηρίων πλέον θα βρίσκεται μια ψηφιακή κάρτα την οποία θα μπορεί να επιδικνύει ο χρήστης
όπως και στην #ΛΑ-26.


### ΜΛΑ-3    *ΑΜΕΑ*

Ο χρήστης θα πρέπει να μπορεί να ενεργοποιεί
